...
#define CPU_FREQUENCY_HZ 8000000 // => Время одного такта равно 1/8МГц = 0.125 мкс
...
#define MAX_VALUE_FOR_MS_DELAY 1610400 // = UINT32_MAX / 2667
...
#define MAX_VALUE_FOR_US_DELAY 1431655765 // = UINT32_MAX / 3
